...
const marketplaceOperations = require('./007-marketplace-operations');

const migrations = [initialSchema, propertyImages, savedItems, domusV2, growthUx, publicSlugs, marketplaceOperations];
